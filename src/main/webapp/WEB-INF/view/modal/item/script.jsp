	...
	jQuery(document).ready(function(){
		...
		/* btn show form add variant */
		 ...
		 $('#btn-add-item-variant').on('click', function(){
				...
				var markup = "<tr class='row-add-variant'><td>" + name + 
					"</td><td style='text-align:center;'>" + price + 
					"</td><td style='text-align:center;'>" + sku + 
					"</td><td style='text-align:center;'>" + beginning + 
					"</td><td style='display:none'>"+ alert + 
		 ...
		 $(document).on('click','.btn-add-edit-update-variant', function(){
			 $('#modal-add-edit-variant').modal('hide');
				...
				var bstock= $('#input-edit-beginning-stock').val();
				var alert= $('#input-edit-alert-at').val();
				...
				"</td><td style='text-align:center;'>" + price + 
				"</td><td style='text-align:center;'>" + sku + 
				"</td><td style='text-align:center;'>" + bstock + 
				"</td><td style='display:none'>"+ alert + 
				"</td><td style='text-align:center;'><a class='btn-add-edit-variant btn btn-info btn-sm' href='#'>Edit</a>|<a class='btn-add-remove-variant btn btn-danger btn-sm' href='#'>X</a></td></tr>";
		...
		/* edit add variant  */
		 ...
		 $(document).on('click', '#btn-edit-add-add-item-variant',function(){
			 	var name= $('#input-edit-add-variant-name').val();
				var sku= $('#input-edit-add-variant-sku').val();
				var price= $('#input-edit-add-variant-price').val();
				var beginning= $('#input-edit-add-beginning-stock').val();
				var alert= $('#input-edit-add-alert-at').val();
				...
				var markup = "<tr class='row-add-variant'><td>" + name + 
					...
					"</td><td style='text-align:center;'>" + beginning + 
					"</td><td style='display:none'>"+ alert + 
					"</td><td style='text-align:center;'><a id='btn-edit-edit-variant' class='btn btn-info btn-sm' href='#'>Edit</a><a class='btn-edit-remove-variant btn btn-danger btn-sm' href='#'>X</a></center></td></tr>";
				$("#tbody-variant").append(markup);
		...
		$('#btn-edit-edit-update-variant').on('click', function(){
			var markup = "<tr class='row-add-variant'><td>" + $('#edit-edit-variant-name').val()+ 
