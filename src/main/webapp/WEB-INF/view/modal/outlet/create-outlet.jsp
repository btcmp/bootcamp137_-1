				...
				<div class="modal-body">
					...
					<div class="form-group">
						<input type="text" data-parsley-required="true"
							class="form-control" id="input-outlet-name"
							aria-describedby="emailHelp" placeholder="Outlet Name"
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								<select class="form-control" data-parsley-required="true"
									name="countries" id="input-province"
									style="width: 210px; margin-right: 30px;" data-size="5">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<select class="form-control" data-parsley-required="true"
									name="countries" id="input-region"
									style="width: 210px; margin-right: 30px;" data-size="5">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<select class="form-control" data-parsley-required="true"
									name="countries" id="input-district"
									style="width: 210px; margin-right: 30px;" data-size="5">
