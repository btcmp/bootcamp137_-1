		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2018 <a>MiniProject Kelompok #1</a>.
			</strong>
		</footer>
	...
	<!-- Bootstrap 3.3.7 -->
	<script
		src="${url}/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
	<!-- DataTables -->
	<script
		src="${url}/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
	<script
		src="${url}/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
	<!-- SlimScroll -->
	<script
